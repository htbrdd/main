...
public class SamEventHandler implements IWorldGenerator 
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world,
	    ...
	    {
			addOreSpawn(SamsMod.samstone, 0, Blocks.obsidian, world, random, x, z, 16, 16, 5 + random.nextInt(5), 4, 20, 60);
	    }
	     ...
	     **/
	    public void addOreSpawn(net.minecraft.block.Block samstone, int metadata, net.minecraft.block.Block obsidian, World world, Random random, int blockXPos, int blockZPos, int maxX, int maxZ, int maxVeinSize, int chancesToSpawn, int minY, int maxY)
	    {
	          ...
	          for(int x = 0; x < chancesToSpawn; x++)
	          {
	                 ...
	                 (new WorldGenMinable(samstone, metadata, maxVeinSize, obsidian)).generate(world, random, posX, posY, posZ);
	          }
	    }
	}