...
public class ItemBerry extends ItemFood {
	...
	private int setpotionAmplifier;
	...
	public ItemBerry(int food, float saturation, boolean wolfFood, String name) 
	{
		...
		setPotionEffect(Potion.nightVision.id, 60, 0, 1F);
		setSecondPotionEffect(Potion.digSpeed.id, 45, 0, 1F);
		setAlwaysEdible();
	...
	protected void onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		super.onFoodEaten(par1ItemStack, par2World, par3EntityPlayer);
        	...
        	{
           		par3EntityPlayer.addPotionEffect(new PotionEffect(this.secondpotionId, this.secondpotionDuration * 20, this.setpotionAmplifier));
        	}
   	}
